...
sudo ufw allow 3003/tcp  # Application port
sudo ufw status
```
...
server {
    listen 80;
    server_name pewa.mkopaje.com;
    return 301 https://pewa.mkopaje.com$request_uri;
}
...
server {
    ...
    ssl_certificate /etc/letsencrypt/live/pewa.mkopaje.com/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/pewa.mkopaje.com/privkey.pem;
