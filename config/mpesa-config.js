...
module.exports = {
    ...
    CALLBACK_URL: process.env.MPESA_CALLBACK_URL || 'https://pewa.mkopaje.com/api/mpesa-callback',
    TIMEOUT_URL: process.env.MPESA_TIMEOUT_URL || 'https://pewa.mkopaje.com/api/mpesa-timeout',
    RESULT_URL: process.env.MPESA_RESULT_URL || 'https://pewa.mkopaje.com/api/mpesa-result',
